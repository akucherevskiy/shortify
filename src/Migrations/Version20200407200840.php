 ...
 */
final class Version20200407200840 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE url (id INT AUTO_INCREMENT NOT NULL, full LONGTEXT NOT NULL, short VARCHAR(255) NOT NULL, created_at INT NOT NULL, UNIQUE INDEX UNIQ_F47645AE8F2890A2 (short), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
